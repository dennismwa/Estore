...
<div class="container-fluid">
    <div class="content">
        <div class="content-header d-flex align-items-center justify-content-between">
            <h4>Manage Sales</h4>
            <a href="index.php?page=sales" class="btn btn-primary"><i class="fas fa-list"></i> List</a>
        </div>
            ...
            <div class="content-data mt-5">
                <form action="" id="sub_sales">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            <div class="form-group">
                                <label for=""><span class="text-danger">*</span> Client Full Nmaes</label>
                                <input type="text" name="name" id="" class="form-control">
                            </div>
                        </div>
                        <div class="col-md-4 mb-3">
                            <div class="form-group">
                                <label for=""><span class="text-danger">*</span> Client Email</label>
                                <input type="email" name="email" id="" class="form-control">
                            </div>
                        </div>
                        <div class="col-md-4 mb-3">
                            <div class="form-group">
                                <label for=""><span class="text-danger">*</span> Client Phone Number</label>
                                <input type="tel" name="phone" id="" class="form-control">
                            </div>
                        </div>
                        <div class="col-md-4 mb-3">
                            <div class="form-group">
                                <label for=""><span class="text-danger">*</span> Client Address</label>
                                <input type="text" name="address" id="" class="form-control">
                            </div>
                        </div>
                        <div class="col-md-4 mb-3">
                            <div class="form-group">
                                <label for=""><span class="text-danger">*</span> Sales Date</label>
                                        ...
                                        if (!empty($_SESSION['products'])) {
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><a href="clear_products_sales.php" class="btn btn-warning">Clear</a></td>
                                                </tr>
                                            <?php
                                        }
                                    ?>
...
<script>
    ...
    $('#sub_sales').submit(function(e){
        ...
        $.ajax({
            url: 'ajax.php?action=save_sales_new',
            method: 'POST',
            type: 'POST',
            ...
            success: function(resp) {
                if (resp == 1) {
                    end_loader()
                    alert_pop("Sales data saved successfully", "success")
                    setTimeout(() => {

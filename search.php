...
<?php include 'inc/header.php'; ?>
    ...
    <main>
        ...
        <div class="items-section">
            <h2 class="text-center mt-5 mb-5">Search result for "<?=$search ?>"</h2>
            <div class="row">
            <?php
                $qry = $conn->query("SELECT products.*, category.name as cat FROM products INNER JOIN category ON category.id=products.category_id WHERE category.name LIKE '%$search%' || products.name LIKE '%$search%'  ORDER BY id DESC");

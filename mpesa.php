<?php
    ...
    $config = array(
        ...
        "key"              => "PuzTg2dtlNLMHbTQNdR1i9G2ZwPaNvnD", //Enter your consumer key here
        "secret"           => "NJAzz8ZXdjdoH5Iu", //Enter your consumer secret here
        "username"         => "MpesaTest",
    ...
    if (isset($_POST['phone_number'])) {
        ...
        if($result['ResponseCode'] === "0"){         //STK Push request successful
            ...
            $save = $conn->query("INSERT INTO payments VALUES(NULL, '$order_no', 'MPESA', '$amount', NULL)");
            if ($save)
